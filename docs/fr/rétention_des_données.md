...
<div class="card-shadow mb-3">
    <div class="card-body">
        ...
        <div class="mb-3">
            Le contenu conservé par le service pendant dix (10) ans ou plus, ou le contenu jugé propice à la préservation à long terme, est régi par une <a href="/policies/fr/préservation/">politique de préservation</a> distincte du DFDR.
        </div>
    </div>
</div>
...
<div class="card-shadow mb-3">
    <div class="card-body">
        ...
        <ul>
            ...
            <li>Exigences légales et violations avérées</li>
            <li>Sécurité nationale</li>
            <li>Intégrité de la recherche </li>
            <li>Questions liées au respect de la vie privée à la confidentialité et à l’éthique </li>
            <li>Violation des conditions d’utilisation du service</li>
        </ul>
...
<div class="card-shadow mb-3">
    <div class="card-body">
        <h2 id="40-application-et-revision">4.0 Application et révision</h2>
